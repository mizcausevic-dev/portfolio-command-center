...
const platformOverrides = {
  ...
  "okta-access-policy-drift-monitor": "Decision Intelligence",
  "tableau-dashboard-lineage-auditor": "Decision Intelligence",
  "powerbi-board-metric-certifier": "Decision Intelligence",
...
const homepageOverrides = {
  ...
  "okta-access-policy-drift-monitor": "https://mizcausevic-dev.github.io/okta-access-policy-drift-monitor/",
  "tableau-dashboard-lineage-auditor": "https://mizcausevic-dev.github.io/tableau-dashboard-lineage-auditor/",
  "powerbi-board-metric-certifier": "https://mizcausevic-dev.github.io/powerbi-board-metric-certifier/",
...
const verticalOverrides = {
  ...
  "program-outcome-proof-ledger": "Nonprofit / Foundation Ops",
  "donor-stewardship-ops-console": "Nonprofit / Foundation Ops",
  "campaign-appeal-fatigue-monitor": "Nonprofit / Foundation Ops",
  ...
  "snowflake-query-credit-guardrail": "Data Engineering",
  "snowflake-cost-governance-studio": "Data Engineering",
  "tableau-dashboard-lineage-auditor": "Data Engineering",
  "powerbi-board-metric-certifier": "Data Engineering",
  ...
  "okta-access-policy-drift-monitor": "IAM / Security",
  "employee-ai-acceptable-use-board": "HR Tech / Employment AI",
  "payment-reconciliation-exception-desk": "FinTech",
  "merchant-risk-review-console": "FinTech",
  "kyc-refresh-case-router": "FinTech",
  "treasury-liquidity-signal-lab": "FinTech",
  "building-access-audit-ledger": "PropTech / Real Estate",
  "lease-obligation-risk-board": "PropTech / Real Estate",
  "tenant-maintenance-escalation-console": "PropTech / Real Estate",
  "robot-fleet-exception-board": "Robotics",
  "sensor-health-drift-monitor": "Robotics",
  "human-override-readiness-console": "Robotics",
  "lab-instrument-change-audit": "Biotech / Diagnostics",
  "batch-deviation-capa-ledger": "Biotech / Diagnostics",
  "specimen-chain-of-custody-console": "Biotech / Diagnostics",
  "gxp-change-control-board": "Biotech / Diagnostics",
  "pharmacovigilance-signal-router": "Biotech / Diagnostics",
  "clinical-event-narrative-review-board": "Biotech / Diagnostics",
